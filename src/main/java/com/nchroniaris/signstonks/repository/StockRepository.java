...
public interface StockRepository extends ConfigurationRepository {
     ...
     *
     * @param stockUUID The {@link UUID} of the {@link com.nchroniaris.mcstonks.stock.Stock} that you want to get the list for
     ...
     */
    @NotNull
    List<Location> getTransactionSigns(UUID stockUUID);
     ...
     */
    @NotNull
    List<Location> getHistorySigns(UUID stockUUID);
     ...
     *
     * @param stockUUID The {@link UUID} of the {@link com.nchroniaris.mcstonks.stock.Stock} that you want to add to
     ...
     */
    void addTransactionSign(UUID stockUUID, Location location) throws AlreadyExistsException;
     ...
     * @throws AlreadyExistsException Thrown when the provided {@link Location} is already being used.
     */
    void addHistorySign(UUID stockUUID, Location location) throws AlreadyExistsException;
     ...
     *
     * @param stockUUID The {@link UUID} of the {@link com.nchroniaris.mcstonks.stock.Stock} that you want to remove from
     ...
     */
    void deleteTransactionSign(UUID stockUUID, Location location) throws DoesNotExistException;
     ...
     * @throws DoesNotExistException Thrown when the provided {@link Location} does not exist in the storage.
     */
    void deleteHistorySign(UUID stockUUID, Location location) throws DoesNotExistException;
     ...
     *
     * @param stockUUID The {@link UUID} of the entry you want to remove.
     * @throws DoesNotExistException Thrown when the provided {@link Location} does not exist in the storage.
     */
    void deleteStockEntry(UUID stockUUID) throws DoesNotExistException;
